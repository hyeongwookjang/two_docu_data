...
def _install_wheel(
    ...
    def data_scheme_file_maker(zip_file, scheme):
        ...
        def make_data_scheme_file(record_path):
            ...
            try:
                ...
                message = (
                    "Unexpected file in {}: {!r}. .basic directory contents"
            ...
            try:
                ...
                message = (
                    "Unknown scheme key used in {}: {} (for file {!r}). .basic"
    ...
    def is_data_scheme_path(path):
        # type: (RecordPath) -> bool
        return path.split("/", 1)[0].endswith(".basic")
    ...
    def pyc_source_file_paths():
        ...
        # file in .basic maps to same location as file in wheel root).
